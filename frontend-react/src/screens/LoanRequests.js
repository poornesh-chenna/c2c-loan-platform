    ...
    const Loading = (btnName) => {
      if (loadingState.loading) {
        if (loadingState.btnName === btnName) {
          return <CircularProgress sx={{ color: 'white' }} size="1.5rem" />
        }
        return btnName
      }
      return btnName
...
=======
        setalertMsg({
          message: 'Loan sanctioned! Check Lendings Tab to see your loans.',
          open: true,
          severity: 'success',
        })
        loadingOff()
...
>>>>>>> 36e5b4708b048592b01bff0ded0c28d8f7679438
    }
          ...
          <Grid container rowGap={'1.5rem'}>
            ...
            <Grid item md={4} xs={12}>
              <Box>
                ...
                <Typography paddingY={'0.5rem'} variant="h5">
                  Loan Amount :
                  {Number(loanRequest.Amount).toLocaleString('en-IN', {
                    style: 'currency',
                    currency: 'INR',
                  })}
                </Typography>
            ...
            <Grid item md={4} xs={12}>
              <Box>
                ...
                <Typography variant="h6">
                  CIBIL : {loanRequest.user_id.cibil || 'No mentioned'}
                </Typography>
              </Box>
            </Grid>
            <Grid item md={4} xs={12}>
              ...
              >
                ...
                >
                  <Button
                    onClick={() => acceptHandler(loanRequest._id)}
                    variant="contained"
                    color="success"
                  >
                    {Loading('Accept')}
                  ...
                  <Button
                    onClick={() => rejectHandler(loanRequest._id)}
                    variant="contained"
                    color="error"
                  >
                    {Loading('Reject')}
    ...
    <Box>
      <Dialog open={dialogState.open}>
        <Box sx={{ padding: '2rem' }}>
          ...
          >
            <Button onClick={() => setdialogState(dialogInitialState)}>
              Cancel
            </Button>
            <Button onClick={() => modifyHandler()} variant="outlined">
              Modify
            </Button>
          </Box>
        </Box>
        ...
        <div>
          <Box sx={{ m: '2rem' }}>
            <Alert severity="info">
              ...
              <strong>There are no loan requests at present .</strong>
              <p>Stay Tuned!</p>
            </Alert>
          </Box>
        </div>
